...
/**
 * Class used to store the data of a graph to be solved.
...
public enum GraphImporter {
    ...
    // Returns an empty instance of the class of g
    // Useful when importing multiple files
    // To start from an empty graph for each file
    ...
    public static Arc importer(final File file, final IGraphe g) {
        try (final Scanner sc = new Scanner(file, StandardCharsets.UTF_8)) {
            ...
            line = sc.nextLine(); // Algorithm name not used
            Arc a = null;
