...
/**
 * Class used for the IHM to store the data of a path to find.
...
public class CheminATrouver {
    ...
    public CheminATrouver(String fileName, String repFileName, IGraphe g, Arc sd_arc, int distance_attendue, List<Integer> chemin_possible) {
